...
export default defineConfig({
  ...
  shortcuts: {
    shell: "min-h-screen bg-[radial-gradient(circle_at_top_right,rgba(232,113,58,0.10),transparent_22rem),linear-gradient(180deg,#fcfaf6_0%,#f7f3ea_100%)] text-ink",
    page: "mx-auto max-w-[1160px] px-5 pb-18 pt-6",
    topbar: "mb-8 flex flex-col gap-4 border-b border-line py-4 md:flex-row md:items-center md:justify-between",
    navpill: "inline-flex min-h-9 items-center rounded-full border border-line bg-paper-strong px-3.5 text-sm font-semibold text-ink no-underline transition duration-200 hover:-translate-y-0.25 hover:border-[#c7bfb0] hover:bg-white",
